...
/* harmony import */ var _modules_bigPicture__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/bigPicture */ "./src/js/modules/bigPicture.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer1', deadline);
  Object(_modules_bigPicture__WEBPACK_IMPORTED_MODULE_4__["default"])();
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var bigPicture = function bigPicture() {
  ...
  workSection.addEventListener('click', function (e) {
    ...
    if (target && target.classList.contains('preview')) {
      ...
      var patch = target.parentNode.getAttribute('href');
...
/* harmony default export */ __webpack_exports__["default"] = (bigPicture);
...
var modals = function modals() {
  var modaWindow = function modaWindow(openSelector, modalselector, closeModalSelector) {
...
var tabs = function tabs(parentTabsSelector, tadsesSelector, contentSelector, activClass) {
  var parentTabs = document.querySelector(parentTabsSelector),
  ...
  parentTabs.addEventListener('click', function (e) {
    ...
    if (target && target.classList.contains(tadsesSelector.replace(/\./, "")) || target.parentNode.classList.contains(tadsesSelector.replace(/\./, ""))) {
      tabses.forEach(function (item, i) {
